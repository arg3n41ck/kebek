      ...
      <TableRow>
        ...
        <TableCell align='right' sx={{ height: '24px' }}>
          ...
          <Menu
            ...
            sx={{ width: '200px' }}
          >
            <MenuItem onClick={() => handleChangeStatusManyGoodsByIds(selected, "AC")}>{locale === "ru" ? "Активировать" : "Іске қосу"}</MenuItem>
            <MenuItem onClick={() => handleChangeStatusManyGoodsByIds(selected, "AR")}>{locale === "ru" ? "Перенести в архив" : "Мұрағатқа жылжытыңыз"}</MenuItem>
          </Menu>
        </TableCell>
      </TableRow>
    </TableHead>
