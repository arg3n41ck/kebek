...
import DeliveryHeadTable from './DeliveryHeadTable';
...
export default function DeliveryTable({ rows, headCells, locale, deleteDelivery, getDelivery, activateDelivery, activateManyDelivery }) {
        ...
        <TableContainer>
          ...
          >
            <DeliveryHeadTable
              ...
              activateManyDelivery={activateManyDelivery}
