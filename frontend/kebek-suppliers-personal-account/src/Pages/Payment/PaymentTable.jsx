...
import PaymentHeadTable from './PaymentHeadTable';
...
export default function PaymentTable({ rows, headCells, activatePayment, deletePayment, getPayment, activateManyPayment }) {
        ...
        <TableContainer>
          ...
          >
            <PaymentHeadTable
              ...
              headCells={headCells}
              selected={selected}
              activateManyPayment={activateManyPayment}
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return <TableRowList
                    ...
                    handleActivatePayment={activatePayment}
                    getPayment={getPayment}
                  />
